...
import { setPostPreview } from '@/lib/redux/postSlice'
...
const CreatePost = () => {
    ...
    console.log("prieviewPost in createPost = ", previewPost)
            ...
            <Card className="w-full border-none">
                ...
                <CardContent className="p-6 space-y-6 border-none">
                    ...
                    <Input
                        ...
                        value={previewPost?.description || description}
                        onChange={(e) => setDescription(e.target.value)}
                    />

                    {/* Image Upload */}
                    <div className=" border-gray-300 rounded-xl p-6 text-center hover:border-primary transition">
                        <UploadDropzone setUploadedImage={setUploadedImage} setImagePreview={setImagePreview} />
                    </div>

                    {/* Rich Text Editor */}
                    <div className="rounded-xl border-none p-3">
                        <RichTextEditor
                            value={previewPost?.content || editorContent}
                    ...
                    <div>
                        {previewPost?.tags && previewPost?.tags.map((tag, index) => (
                            <span
                                key={index}
